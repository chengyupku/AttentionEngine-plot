...
providers = deepseek_fwd_providers
times_data = deepseek_fwd_times_data
...
providers = llama_fwd_providers
times_data = llama_fwd_times_data
_1x_baseline_times = dict(times_data)[_1x_baseline]
norm_time_data = []
for label, times in times_data:
    # if label != _1x_baseline:
...
providers = dit_fwd_providers
times_data = dit_fwd_times_data
_1x_baseline_times = dict(times_data)[_1x_baseline]
norm_time_data = []
for label, times in times_data:
    # if label != _1x_baseline:
...
providers = sigmoid_fwd_providers
times_data = sigmoid_fwd_times_data
_1x_baseline_times = dict(times_data)[_1x_baseline]
norm_time_data = []
for label, times in times_data:
    # if label != _1x_baseline:
...
providers = gla_fwd_providers
times_data = gla_fwd_times_data
_1x_baseline_times = dict(times_data)[_1x_baseline]
norm_time_data = []
for label, times in times_data:
    # if label != _1x_baseline:
...
providers = relu_fwd_providers
times_data = relu_fwd_times_data
_1x_baseline_times = dict(times_data)[_1x_baseline]
norm_time_data = []
for label, times in times_data:
    # if label != _1x_baseline:
...
providers = mamba_fwd_providers
times_data = mamba_fwd_times_data
_1x_baseline_times = dict(times_data)[_1x_baseline]
norm_time_data = []
for label, times in times_data:
    # if label != _1x_baseline:
...
providers = retnet_fwd_providers
times_data = retnet_fwd_times_data
_1x_baseline_times = dict(times_data)[_1x_baseline]
norm_time_data = []
for label, times in times_data:
    # if label != _1x_baseline:
...
providers = gated_retnet_fwd_providers
times_data = gated_retnet_fwd_times_data
_1x_baseline_times = dict(times_data)[_1x_baseline]
norm_time_data = []
for label, times in times_data:
    # if label != _1x_baseline:
...
providers = retnet_chunk_fwd_providers
times_data = retnet_chunk_fwd_times_data
_1x_baseline_times = dict(times_data)[_1x_baseline]
norm_time_data = []
for label, times in times_data:
    # if label != _1x_baseline:
